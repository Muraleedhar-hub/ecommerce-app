...
export class CartService {
  ...
  //private ServerURL = 'http://productservice-env.eba-mqthqfk6.us-east-1.elasticbeanstalk.com';
  ...
  DeleteProductFromCart(index) {
    ...
    CheckoutFromCart(userId: Number, shippingAddress: ShippingAddress, billingAddress:BillingAddress, isShippingAndBillingAddressSame:Boolean) {
    //this.httpClient.post(`${this.ServerURL}orders/payment`, null).subscribe((res: { success: Boolean }) => {
      console.clear();
      if (true) {
        this.resetServerData();
        this.httpClient.post('https://yrsg651mjj.execute-api.us-east-1.amazonaws.com/v1/order-service', {
          customerId: 'murali234@gmail.com',
          userId: userId,
